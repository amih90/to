    ...
    if ("undefined" != typeof self && self.Prism && self.document) {
        ...
        o.hooks.add("before-highlightall", function(e) {
            ...
            if (t.matches(d)) {
                ...
                r.open("GET", n, !0), r.onreadystatechange = function() {
...
! function() {
    if ("undefined" != typeof self && self.Prism && self.document) {
        ...
        Prism.hooks.add("before-highlightall", function(t) {
            ...
            if (r.matches(b)) {
                ...
                d.src = s.href, window[u] = function(t) {
                    document.head.removeChild(d), clearTimeout(l), delete window[u];
                    var e = null;
                    if (o) e = o(t, r);
                    else
                        for (var n = 0, a = c.length; n < a && null === (e = c[n].adapter(t, r)); n++);
    ...
    function t(t, e) {
        e = e || t.name, "function" != typeof t || n(t) || n(e) || c.push({
            adapter: t,
            name: e
        })
    }
...
! function() {
    if ("undefined" != typeof self && self.Prism && self.document && document.createElement) {
        ...
        if (a) {
            ...
            if (null != i) e = i.trim().replace(/\/?$/, "/");
                ...
                var s = a.src;
                r.test(s) ? e = s.replace(r, "components/") : t.test(s) && (e = s.replace(t, "$1components/"))
            }
        }
        ...
        Prism.hooks.add("complete", function(e) {
            ...
            if (a && r && "none" !== r) {
                ...
                t.push(r), t.every(u) || m(t, function() {
    ...
    function u(e) {
        ...
        if ((e = l[e] || e) in Prism.languages) return !0;
        var a = p[e];
                ...
                function e() {
                    ...
                    e || (e = p[a] = {
                        ...
                        t.src = e, t.async = !0, t.onload = function() {
                            ...
                            document.body.removeChild(t), r && r()
    ...
    function k(e, a) {
        if (p[e]) {
            for (var r = p[e].callbacks, t = 0, i = r.length; t < i; t++) {
                var s = r[t][a];
                s && setTimeout(s, 0)
            }
            r.length = 0
...
"undefined" != typeof self && self.Prism && self.document && (Prism.plugins.UnescapedMarkup = !0, Prism.hooks.add("before-highlightall", function(e) {
    ...
    if ((t.element.matches || t.element.msMatchesSelector).call(t.element, "script[type='text/plain']")) {
        ...
        return (l = document.createElement("pre")).className = e.className = t.element.className, t.element.dataset && Object.keys(t.element.dataset).forEach(function(e) {
    ...
    var l = t.element.parentNode;
    !t.code && l && "pre" == l.nodeName.toLowerCase() && t.element.childNodes.length && "#comment" == t.element.childNodes[0].nodeName && (t.element.textContent = t.code = t.element.childNodes[0].textContent)
}));
! function() {
